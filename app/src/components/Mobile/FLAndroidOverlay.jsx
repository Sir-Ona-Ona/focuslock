...
export default function FLAndroidOverlay({ appName = 'TikTok' }) {
  return (
    <div style={{
      width: '100%',
      height: '100%',
      ...
      <div style={{ flex: 1, padding: '36px 28px 16px', display: 'flex', flexDirection: 'column', alignItems: 'stretch', gap: 18 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{
            ...
            color: 'var(--ink-mute)', letterSpacing: '0.18em', textTransform: 'uppercase',
          }}>{appName}</div>
        </div>
        ...
        <p style={{ margin: 0, fontSize: 13, color: 'var(--ink-3)', lineHeight: 1.5, textAlign: 'center', padding: '0 14px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 4 }}>
          <div className="fl-otp" style={{ gap: 6 }}>
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="d" style={{ width: 36, height: 48, fontSize: 22 }} />
            ))}
          </div>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 6 }}>
          <span style={{
            ...
            textUnderlineOffset: 3, textDecorationColor: 'var(--stone)', cursor: 'pointer',
