// Partner email — what the accountability partner sees in their inbox.
// Rendered inside a faux mail client window.

function FLEmailClient() {
  return (
    <div className="fl-screen" style={{
          ...
          <div key={i} style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
              <span style={{
                ...
                {m.tagged && <span style={{ width: 6, height: 6, background: 'var(--bronze)' }} />}
                {m.from}
              </span>
      ...
      {/* Reader pane — the active message */}
      <article style={{
        display: 'flex', flexDirection: 'column',
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: 14, lineHeight: 1.6, color: '#3A332A' }}>
            Maryam,
          </p>
          ...
          {/* The code, as a sealed cartouche */}
          <div style={{
            margin: '28px 0',
            ...
            <div>
              ...
              <div style={{
                ...
                fontSize: 34, letterSpacing: '0.12em',
                color: 'var(--ink)',
              }}>4 8 2 9 1 7</div>
...
Object.assign(window, { FLEmailClient });
